...
def create_dataset(username):
	...
	predictor = dlib.shape_predictor("C:\\Users\\User\\Desktop\\Attendance-Management-System-Using-Face-Recognition\\Attendance-System-Using-Face-Recognition\\recognition\\shape_predictor_68_face_landmarks.dat")   #Add path to the shape predictor ######CHANGE TO RELATIVE PATH LATER
	...
	while(True):
		...
		for face in faces:
			...
			cv2.rectangle(frame,(int(x),int(y)),(x+w,y+h),(0,255,0),1)
